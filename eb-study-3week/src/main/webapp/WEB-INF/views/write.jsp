        ...
        <div>
            <div style="margin-top: 2%; margin-left:5%;" >
                <div align="center"  style="margin-top: 5%;">
                    <form action="${pageContext.request.contextPath}/write" enctype="multipart/form-data" name="writeForm" style="margin-bottom: 5%; margin-top: 2%" method="post" onsubmit="return checkForm()"  >
